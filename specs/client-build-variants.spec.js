...
const ClientJSBase = require('../src/client.base');
const ClientJSFlash = require('../src/client.flash');
const ClientJSJava = require('../src/client.java');
const ClientJSFull = require('../src/client');
